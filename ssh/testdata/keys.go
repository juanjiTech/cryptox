...
`),
	// ssh-keygen -s ca -I testuser -n testuser -V always:forever rsa.pub
	"rsa_testuser": []byte(`ssh-rsa-cert-v01@openssh.com  rsa.pub
`),
	// ssh-keygen -s ca -I testuser -n testuser -V always:forever -O source-address=192.168.1.0/24 rsa.pub
	"rsa_testuser_nonlocal_source_address": []byte(`ssh-rsa-cert-v01@openssh.com  rsa.pub
`),
	// ssh-keygen -s ca -I testuser -n testuser -V always:forever -O source-address=127.0.0.1 rsa.pub
	"rsa_testuser_local_source_address": []byte(`ssh-rsa-cert-v01@openssh.com  rsa.pub
`),
